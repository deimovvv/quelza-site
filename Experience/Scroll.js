...
export default class Scroll{
    constructor(){
        ...
        // we translate this element when scrolllin (y-axis)
        ...
        this.getScroll()
        this.init()
        // the main element syule needs to be modified
        this.style()
        // init/bind events
        this.initEvents()
    ...
    init(){
        ...
        // translate the scroolable elemnt
        this.setPosition()
    ...
    initEvents(){
        ...
        // on resize reset the bodys height
